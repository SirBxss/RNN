    ...
    def test_regularization_loss(self):
        ...
        for layer in [fcl, rnn]:
            ...
            for reg in [False, True]:
                ...
                print(f"Loss Layer Loss: {np.sum(net.loss_layer.loss)}")
                if reg:
                    print(f"Expected Regularization Loss: {current_loss - np.sum(net.loss_layer.loss)}")

            print(f"Final Losses for Layer {layer.__class__.__name__}: {loss}")
